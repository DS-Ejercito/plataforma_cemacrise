...
class incidencia(models.Model):
    ...
    tp_incidencia = models.ForeignKey(procedencia, on_delete=models.CASCADE)
    depto = models.ForeignKey(procedencia, on_delete=models.CASCADE)
    munic = models.ForeignKey(procedencia, on_delete=models.CASCADE)
